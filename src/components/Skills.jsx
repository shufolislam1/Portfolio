    ...
    return (
        <div className='mt-32' id='skill'>
            ...
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                        <img src="https://img.icons8.com/color/240/null/tailwindcss.png" alt="tailwindCSS" className="rounded-xl" />
                    </figure>
                </div>
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-10">
                ...
                <div className="card w-96 bg-base-100 shadow-xl">
                    <figure className="px-10 pt-24 ">
                        <img src="https://i.ibb.co/T4LDxdW/Expressjs.png" alt="mongodb" className="rounded-xl" />
                    </figure>
                </div>
            </div>
        </div>
